			...
			<lxslt:component prefix="my-ext" functions="formatJson,retrievePrizeTable,getType">
				<lxslt:script lang="javascript">
					...
					function formatJson(jsonContext, translations, prizeTable, prizeValues, prizeNamesDesc)
					{
 					...
 					//	r.push(getTranslationByName("mainHeader", translations));
 					//	r.push('</td>');
 					//	r.push('</tr>');
 					//	r.push('</table>');
					...
					//	{
 					//		r.push('<tr>');
					//		r.push('<td>');
							//r.push(formatter.format(mainCashWin));
					//		r.push(mainCashWin);
					//		r.push('</td>');
 					//		r.push('</tr>');
					//	}
						...
						{	// "I11,115,57,59:I9,242,68,61:I7,354,67,49:I5,487,63,65:I2,616,61,67"
							...
							r.push('<tr>');
 							r.push('<td class="tablehead" width="20%">');
 							r.push(getTranslationByName("iName", translations));
 							r.push('</td>');
 							r.push('<td class="tablehead" width="15%">');
 							r.push(getTranslationByName("targetPrize", translations));
 							r.push('</td>');
 							r.push('<td class="tablehead" width="10%">');
	 						r.push(getTranslationByName("coinsTarget", translations));
							r.push('</td>');
							r.push('<td class="tablehead" width="10%">');
 							r.push(getTranslationByName("iFirst", translations));
							r.push('</td>');
 							r.push('<td class="tablehead" width="10%">');
 							r.push(getTranslationByName("iSecond", translations));
 							r.push('</td>');
 							r.push('<td class="tablehead" width="10%">');
 							r.push(getTranslationByName("coinsTotal", translations));
 							r.push('</td>');
 							r.push('<td class="tablehead" width="15%">');
 							r.push(getTranslationByName("wins", translations));
 							r.push('</td>');
							...
							for(var i = 0; i < bonus1Data.length; ++i)
							{
								...
								if (playData[2] > 0)
								{
									...
									r.push('<tr>');
									r.push('<td>');
									r.push(getTranslationByName("island"+(i+1), translations));
									r.push('</td>');
									for(var j = 0; j < playData.length; j++)
									{
										r.push('<td>');
								...
								//	{
								//		r.push('<td>');
								//		r.push(getTranslationByName("cannonLose", translations));
								//		r.push('</td>');
								//	}
 									r.push('</tr>');
								}

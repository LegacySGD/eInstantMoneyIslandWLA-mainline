...
public class MoneyIslandWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MoneyIslandWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MoneyIslandWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MoneyIslandWLAIW/InitOutcome.xml").getDocumentElement();
